...
import type { IdentityClient as _identity_IdentityClient, IdentityDefinition as _identity_IdentityDefinition } from './identity/Identity';
...
export interface ProtoGrpcType {
  identity: {
    Identity: SubtypeConstructor<typeof grpc.Client, _identity_IdentityClient> & { service: _identity_IdentityDefinition }
