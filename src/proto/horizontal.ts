...
import type { HorizontalClient as _horizontal_HorizontalClient, HorizontalDefinition as _horizontal_HorizontalDefinition } from './horizontal/Horizontal';
...
export interface ProtoGrpcType {
  horizontal: {
    ...
    Horizontal: SubtypeConstructor<typeof grpc.Client, _horizontal_HorizontalClient> & { service: _horizontal_HorizontalDefinition }
